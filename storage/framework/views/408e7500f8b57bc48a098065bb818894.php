...
<div class="container mt-5">
    <div class="card shadow">
        ...
        <div class="card-body">
            <form action="<?php echo e(url('/pos/clientes')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="d-flex justify-content-between">
                    <a href="<?php echo e(url('/pos')); ?>" class="btn btn-secondary">Cancelar</a>
...
<?php /**PATH /workspace/laravel/parcial/resources/views/pos/clientes/create.blade.php ENDPATH**/ ?>